...
<aside class="w-64 bg-green-800 text-white p-6 flex-shrink-0">
  <div class="flex flex-col items-center mb-6">
    <img src="<?php echo e(asset('logo/log.png')); ?>" alt="شعار" class="w-20 h-20 rounded-full object-cover shadow mb-2">
...
<?php /**PATH C:\Users\labo\Desktop\nahda-platform\resources\views/admin.blade.php ENDPATH**/ ?>